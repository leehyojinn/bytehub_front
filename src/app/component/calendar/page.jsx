...
const calendar_events = [
  ...
  { id: "c2", title: "개발팀 스프린트 미팅", date: "2025-07-04", type: "team", team_id: 1, allowed_grades: ["A", "B"], visible_to_team: true },
    ...
    <div>
        ...
        <div className="wrap padding_60_0">
            ...
            <div className="flex gap_10 align_center mb_20 justify_between">
                ...
                <button className="caleandar_btn" onClick={() => setShowModal(true)}>+ 일정 등록</button>
            </div>
            <FullCalendar
            ...
            {showModal && (
                ...
                <div className="modal_content" onClick={e => e.stopPropagation()}>
                    <h3 className="card_title font_700 mb_20">개인 일정 등록</h3>
                    ...
                    <div className="modal_buttons">
                        ...
                        <button type="button" className="board_btn board_btn_cancel" onClick={() => setShowModal(false)}>취소</button>
                    </div>
                    </form>
                </div>
                </div>
